...
dwg.add(dwg.polygon([(0,0),(IMG_SIZE,0),(IMG_SIZE,IMG_SIZE),(0,IMG_SIZE)], fill='blue'))
dwg.add(dwg.polygon(gen_polygon_stats(TEST), fill='yellow'))
dwg.add(dwg.polyline(gen_polygon(((IMG_SIZE-SIZE)/2+SIZE)/2), fill='none'))
# add_polygon(TEST)
dwg.save()